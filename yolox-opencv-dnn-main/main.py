...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", type=str, default='000.png', help="Path to your input image.")
    ...
    net = yolox("chess.onnx", p6=False, confThreshold=0.3)
    srcimg = cv2.imread("000.jpg")
