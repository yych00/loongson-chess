...
void Piece::init(Paintboard *paintboard,string Pos,int y,int x,string pieceCharName)
{
    this->paintboard = paintboard;
    if(pieceCharName.compare("0"))
    {
        ...
        this->pieceCharName = pieceCharName;
        this->transformStyleSheet(pieceCharName);
...
void Piece::checkStay(int x,int y)
{
    ...
    this->paintboard->uiMovePiece(fishWalk, 1);
